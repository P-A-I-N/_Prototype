...
using Stayhome.Interfaces;
using UnityEngine;
using UnityEngine.UI;

public class BlockPointer : MonoBehaviour, IDropZone
{
    ...
    private Image perent;

    private void Awake()
    {
        perent = gameObject.GetComponent<Image>();
    }

    public void InstallTower(GameObject gameObject)
    {
        Instantiate(gameObject);
        perent.enabled = false;
    }
}
